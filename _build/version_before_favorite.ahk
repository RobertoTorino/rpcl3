...
Gui, Add, Button, gShowAll x20 y55 w60 h20, Show All
Gui, Add, Button, gShowFavorites x85 y55 w60 h20, Favorites
Gui, Add, Button, gShowPlayed x150 y55 w50 h20, Played
Gui, Add, Button, gShowPSN x205 y55 w40 h20, PSN
Gui, Add, Button, gShowArcade x250 y55 w50 h20, Arcade
...
ShowFavorites:
    ...
    sql := "SELECT GameId, GameTitle, Eboot, Icon0, Pic1 FROM games WHERE Favorite = 1 ORDER BY GameTitle LIMIT 50"
...
ShowPlayed:
    ...
    sql := "SELECT GameId, GameTitle, Eboot, Icon0, Pic1 FROM games WHERE Played = 1 ORDER BY GameTitle LIMIT 50"
...
ShowPSN:
    ; Show only PSN games
    sql := "SELECT GameId, GameTitle, Eboot, Icon0, Pic1 FROM games WHERE PSN = 1 ORDER BY GameTitle LIMIT 50"
...
ShowArcade:
    ...
    sql := "SELECT GameId, GameTitle, Eboot, Icon0, Pic1 FROM games WHERE ArcadeGame = 1 ORDER BY GameTitle LIMIT 50"
